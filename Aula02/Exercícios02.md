...
-out dados/annovar/AMOSTRA01_S1 -out dados/annovar/AMOSTRA01_anotada -remove -protocol refGene,exac03,abraom,clinvar_20190114 -operation g,f,f,f -nastring "N/A" -csvout
```
